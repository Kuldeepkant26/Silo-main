...
export default function MyRequestsPage() {
  ...
  return (
    <section className="flex flex-col h-screen overflow-hidden p-4 sm:p-6 md:p-10 md:pb-4">
      <header className="mb-4 sm:mb-6 shrink-0">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">{t("my_requests")}</h1>
      </header>
